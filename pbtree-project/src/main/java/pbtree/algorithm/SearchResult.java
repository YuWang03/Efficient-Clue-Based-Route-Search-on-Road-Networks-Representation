...
/**
 * Stores the result of BAB search with PB-Tree optimization.
 */
public class SearchResult {
    ...
    private final int labelBuildTimeMs;
    private final int pbTreeBuildTimeMs;
    private final int totalIterations;
    
    public SearchResult(List<Long> bestPath, double matchingDistance, 
                       List<SearchStep> searchSteps, long executionTimeMs,
                       int labelBuildTimeMs, int pbTreeBuildTimeMs, int totalIterations) {
        ...
        this.labelBuildTimeMs = labelBuildTimeMs;
        this.pbTreeBuildTimeMs = pbTreeBuildTimeMs;
    ...
    public int getLabelBuildTimeMs() { return labelBuildTimeMs; }
    public int getPbTreeBuildTimeMs() { return pbTreeBuildTimeMs; }
    ...
    public static class SearchStep {
        ...
        public Long pivot;                           // Current pivot being searched
        public List<PBTree.SearchStep> pbTreeSteps;  // PB-Tree search details
